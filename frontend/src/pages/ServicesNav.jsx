...
export default function ServicesNav() {
    ...
    const classname = [
        "p-1 py-4 rounded-2xl bg-bcyellow text-2xl text-gray-600",
        "p-1 py-4 rounded-2xl bg-bclightblue text-2xl text-gray-200 hover:text-gray-600 hover:bg-bcyellow transition-colors duration-300"
    ]
