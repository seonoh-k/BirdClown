...
export default function ServicesNav() {
    ...
    const classname = [
        "p-1 py-3 md:py-4 rounded-2xl bg-bcyellow text-xl md:text-2xl text-gray-600",
        "p-1 py-3 md:py-4 rounded-2xl bg-bclightblue text-xl md:text-2xl text-gray-200 hover:text-gray-600 hover:bg-bcyellow transition-colors duration-300"
    ]
        ...
        <div className="flex items-center gap-4 mb-6">
            <div className={isPerformance ? classname[0] : classname[1]}>
                <Link to="/services/performance" 
                    className="px-3 py-2 md:px-6 md:py-3 border border-white rounded-xl"
                >
                    퍼포먼스
                </Link>
            </div>
