...
export default function Contact() {
    return (
        ...
        <div className="flex flex-col max-w-[400px] md:max-w-8xl mx-auto my-10 md:my-20 items-center text-center">
            <h1 className="text-3xl md:text-3xl md:text-5xl mb-6">
                <span className="text-4xl md:text-4xl md:text-6xl text-bcgreen">C</span>ontact Us
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 w-full my-10 text-center text-2xl md:text-3xl gap-4">
